...
public class DTTextField: UITextField {
    ...
    public var paddingYFloatLabel:CGFloat = 7.0{
        didSet{ invalidateIntrinsicContentSize() }
    }
    ...
    fileprivate func showFloatingLabel(_ animated:Bool) {
        ...
        if animated && animateFloatPlaceholder {
            UIView.animate(withDuration: floatingLabelShowAnimationDuration, delay: 0.0, options: [.beginFromCurrentState,.curveEaseOut], animations: animations){ status in
    ...
    override public var intrinsicContentSize: CGSize {
        ...
        if showErrorLabel {
            ...
            return CGSize(width: textFieldIntrinsicContentSize.width, height: textFieldIntrinsicContentSize.height + paddingYFloatLabel + paddingYErrorLabel + lblFloatPlaceholder.bounds.size.height + lblError.bounds.size.height + paddingHeight)
        } else {
            return CGSize(width: textFieldIntrinsicContentSize.width, height: textFieldIntrinsicContentSize.height + paddingYFloatLabel + lblFloatPlaceholder.bounds.size.height + paddingHeight)
        }
    }
    ...
    override public func layoutSubviews() {
        ...
        dtLayer.frame = CGRect(x: bounds.origin.x, y: bounds.origin.y, width: bounds.width, height: dtLayerHeight)

//  CornerCallView.swift
//  sample-videochat-webrtc-swift
//  Created by Injoit on 12/18/18.
//  Copyright © 2018 QuickBlox. All rights reserved.

import UIKit
struct CornerCallViewConstant {
    static let fontName = "Helvetica"
}

class CornerCallView: UIView {
    //MARK: - Properties
    ...
    private func draw(withBgColor bgColor: UIColor, cornerRadius: CGFloat, rect: CGRect, text: String,
        ...
        let rectangleFontAttributes = [NSAttributedString.Key.font: UIFont(name: CornerCallViewConstant.fontName,
                                                                           size: fontSize),

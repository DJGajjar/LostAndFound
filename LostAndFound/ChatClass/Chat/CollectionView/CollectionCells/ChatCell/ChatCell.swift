...
class ChatCell: UICollectionViewCell, UIGestureRecognizerDelegate, ChatReusableViewProtocol, ChatCellProtocol {
  ...
  class func registerForReuse(inView dataView: Any) {
    ...
    override func apply(_ layoutAttributes: UICollectionViewLayoutAttributes) {
        ...
        if let avatarContainerViewHeightConstraint = avatarContainerViewHeightConstraint, let avatarContainerViewWidthConstraint = avatarContainerViewWidthConstraint {
        ...
        if let messageContainerTopInsetConstraint = messageContainerTopInsetConstraint, let messageContainerLeftInsetConstraint = messageContainerLeftInsetConstraint, let messageContainerBottomInsetConstraint = messageContainerBottomInsetConstraint, let messageContainerRightInsetConstraint = messageContainerRightInsetConstraint {
